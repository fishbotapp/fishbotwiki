...
![image](https://fishbot.app/items/orbcore.png) Level 48: Combine 3x `___orb` and 1x `orbcore` to make 1x `___relic`\
![image](https://fishbot.app/items/orbcore.png) Level 60: Combine 3x `___relic` and 2x `orbcore` to make 1x `___requiem`
