...
|  ![mulchmasterscrate](https://github.com/user-attachments/assets/fa58c90e-3c38-44e9-8599-df1ffaf75345) | Mulchmasterscrate | 50 | 150x `megamulch` | 20,000 craft xp |
| ![coincrate](https://github.com/user-attachments/assets/87060fdd-045e-428b-8211-131fd285ffd6) | ???????? | 50 | 500x `rustycoin`| 20,000 craft xp |
| ![bovacreate](https://github.com/user-attachments/assets/ff8537c8-954f-4440-bdb8-d58cd8af20e3) | ???????? | 50 | 600x `bova` | 20,000 craft xp |
...
| Icon | Name | Slot | Obtained | Details | Bonus Per Piece |
| ------ | ------ | ------- | ---- | ---- | ---- |
| ![mulchmastershelm](https://github.com/user-attachments/assets/531e70fb-d8f7-47c5-bbcb-b85e1536688f)| Mulchmastershelm | Head | 1 in 5 chance from `mulchmasterscrate` |  *When worn: Any exp gained while mulching will roll for shilling and shell too*  | *-2 mulch required to make megamulch*|
| ![mulchmastersvest](https://github.com/user-attachments/assets/fc44961e-7e8c-42a2-9654-15d1ea28badd)| Mulchmastersvest | Chest | 1 in 5 chance from `mulchmasterscrate` | *When worn: Has a chance to convert corner events to mulchpiles after claiming. Only those who are wearing this can ravage the mulchpiles for free mulch*|*-2 mulch required to make megamulch*|
...
| Icon | Name | Slot | Obtained | Details | Bonus Per Piece |
| ------ | ------ | ------- | ---- | ---- | ---- |
| ![image](https://github.com/user-attachments/assets/59307d61-9079-4dc9-8631-8a7a44f46b8a)| ???????? | Head | 1 in 5 chance from `????????` |  ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/c7ac59f9-e93a-47af-9f2c-770a8dc744e5) | ???????? | Chest | 1 in 5 chance from `????????` | *When worn: Adds a bova claim to your blingbox, also every bova claim: rolls a 2% chance per bova item in your col log for a free bova* | ???????? |
| ![image](https://github.com/user-attachments/assets/87a267fa-c4be-4396-8f65-8d60dd03eb1a) | ???????? | Legs | 1 in 5 chance from `????????` | *When worn: adds fishberry, thieveberry and craftberry to all thieve locations droptable* |???????? |
| ![image](https://github.com/user-attachments/assets/b69cdda1-b992-46e3-892b-39a560e492b5) | ???????? | Hands | 1 in 5 chance from `????????`| ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/d77b8dfb-3be9-494c-950e-b47d54255c92)| ???????? | Feet | 1 in 5 chance from `????????` | *When worn: You dont need to be fishing to claim a bova and 8% chance to double any berry received* | ???????? |


## Master Set: ??????

Comes from: ![coincrate](https://github.com/user-attachments/assets/87060fdd-045e-428b-8211-131fd285ffd6)  `???????`

| Icon | Name | Slot | Obtained | Details | Bonus Per Piece |
| ------ | ------ | ------- | ---- | ---- | ---- |
| ![image](https://github.com/user-attachments/assets/59307d61-9079-4dc9-8631-8a7a44f46b8a)| ???????? | Head | 1 in 5 chance from `????????` | *When worn: When thieving, grants a very small chance to sacrafice your note (craftbox and under) for 3000 thieve xp and a random gem* | ???????? |
| ![image](https://github.com/user-attachments/assets/c7ac59f9-e93a-47af-9f2c-770a8dc744e5) | ???????? | Chest | 1 in 5 chance from `????????` | ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/87a267fa-c4be-4396-8f65-8d60dd03eb1a) | ???????? | Legs | 1 in 5 chance from `????????` | ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/b69cdda1-b992-46e3-892b-39a560e492b5) | ???????? | Hands | 1 in 5 chance from `????????`| *When worn: Any rapier, fencer, spiritstaff, transmogstaff or similar item will be 15% harder to break and grant 2000 thieve xp when breaking* | ???????? |
| ![image](https://github.com/user-attachments/assets/d77b8dfb-3be9-494c-950e-b47d54255c92)| ???????? | Feet | 1 in 5 chance from `????????` | ????????| ???????? |


## Master Set: ??????

Comes from: ![gemcrate](https://github.com/user-attachments/assets/ed8fc257-3782-4eaa-9de4-a5a891244cb0) `???????`

| Icon | Name | Slot | Obtained | Details | Bonus Per Piece |
| ------ | ------ | ------- | ---- | ---- | ---- |
| ![image](https://github.com/user-attachments/assets/59307d61-9079-4dc9-8631-8a7a44f46b8a)| ???????? | Head | 1 in 5 chance from `????????` |  ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/c7ac59f9-e93a-47af-9f2c-770a8dc744e5) | ???????? | Chest | 1 in 5 chance from `????????` | ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/87a267fa-c4be-4396-8f65-8d60dd03eb1a) | ???????? | Legs | 1 in 5 chance from `????????`  | *When worn: Any gem received has a 25% chance to double* | ???????? |
| ![image](https://github.com/user-attachments/assets/b69cdda1-b992-46e3-892b-39a560e492b5) | ???????? | Hands | 1 in 5 chance from `????????` | *When worn: Any gem received grants a bonus free 2-5 crushedgem too* | ????????
| ![image](https://github.com/user-attachments/assets/d77b8dfb-3be9-494c-950e-b47d54255c92)| ???????? | Feet | 1 in 5 chance from `????????` | ????????| ???????? |


## Master Set: ??????

Comes from: ![lobcrate](https://github.com/user-attachments/assets/56c376aa-0ca3-46f5-b962-b965cdc7d0de)   `???????`

| Icon | Name | Slot | Obtained | Details | Bonus Per Piece |
| ------ | ------ | ------- | ---- | ---- | ---- |
| ![image](https://github.com/user-attachments/assets/59307d61-9079-4dc9-8631-8a7a44f46b8a)| ???????? | Head | 1 in 5 chance from `????????` |  ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/c7ac59f9-e93a-47af-9f2c-770a8dc744e5) | ???????? | Chest | 1 in 5 chance from `????????` | *When worn: +2 PWR in boss battles, albinolobster gives 1.5% lobster gained per instead of 1%. Also, albinolobster is 2% easier to find and grants 15k fishing exp when found* | ???????? |
| ![image](https://github.com/user-attachments/assets/87a267fa-c4be-4396-8f65-8d60dd03eb1a) | ???????? | Legs | 1 in 5 chance from `????????` | ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/b69cdda1-b992-46e3-892b-39a560e492b5) | ???????? | Hands | 1 in 5 chance from `????????`| ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/d77b8dfb-3be9-494c-950e-b47d54255c92)| ???????? | Feet | 1 in 5 chance from `????????` | *When worn: Allows up to 5x clawgetterboots to stack if you have them in your inv. Clawgetterboots proc gives a 1% chance at a free lobsterclawpack* | ???????? |


## Master Set: ??????

Comes from: ![slimecrate](https://github.com/user-attachments/assets/115f134c-04e9-4e25-a521-fbe4ced78e1d)   `???????`

| Icon | Name | Slot | Obtained | Details | Bonus Per Piece |
| ------ | ------ | ------- | ---- | ---- | ---- |
| ![image](https://github.com/user-attachments/assets/59307d61-9079-4dc9-8631-8a7a44f46b8a)| ???????? | Head | 1 in 5 chance from `????????` | *When worn: Any UDT hit will give a free 200+ babyeel and 5+ eel* | ???????? |
| ![image](https://github.com/user-attachments/assets/c7ac59f9-e93a-47af-9f2c-770a8dc744e5) | ???????? | Chest | 1 in 5 chance from `????????` | ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/87a267fa-c4be-4396-8f65-8d60dd03eb1a) | ???????? | Legs | 1 in 5 chance from `????????` | ???????? | ???????? |
| ![image](https://github.com/user-attachments/assets/b69cdda1-b992-46e3-892b-39a560e492b5) | ???????? | Hands | 1 in 5 chance from `????????` | *When worn: Any eel or babyeel sold to store grants 2 thieve xp each* | ???????? |
| ![image](https://github.com/user-attachments/assets/d77b8dfb-3be9-494c-950e-b47d54255c92)| ???????? | Feet | 1 in 5 chance from `????????` | ????????| ???????? |
