...
| ![image](https://fishbot.app/items/starterrod.png) | Starterrod | | Comes with a new account | *All noobs gotta start from somewhere!* | On the Rod slot |  | |
...
| ![image](https://fishbot.app/items/safekit.png) | Safekit | 900k | Pirate chests | *Allows you to take Safe XXL fishing trips. This will be an xxl trip, but can never be longer than a fishbot reset. Use by doing !fish sxxl* | |  | |
...
| ![image](https://fishbot.app/items/greyelfsocks.png) | GreyElfSocks |  |  | *Magical elf socks which give you a tiny chance to get a free mulch whenever you gain exp. 3x more chance if worn, 3x more chance if its within 30 days of xmas* |  | | |
...
| ![image](https://fishbot.app/items/marrow.png) | Marrow | | | *The goopy, sticky nutritional stuff from inside a bone* | | | |
| ![image](https://fishbot.app/items/medpearl.png) | Medpearl | | | *A decent sized pearl, should fetch a great price if sold to the shop.* | | | |
| ![image](https://fishbot.app/items/pinkpearl.png) | Pinkpearl | | | *Wow! Im lucky to find such a rare pearl. Gives +200 gold per payday. Does not stack with itself.* | | | |
| ![image](https://fishbot.app/items/mysticgown.png) | Mysticgown | | | *When worn, there is a 10% chance to get a free orbcore when you send an xxl fishing trip. 1 in 2 chance to break per orbcore found.* | Yes (Chest) | | |
| ![image](https://fishbot.app/items/redskelemask.png) | Redskelemask | | | *Fishbot Halloween 24, ahhh, it was late but great! If worn, will grant a small chance to find bone while thieving* | Yes (Face) | | |
| ![image](https://fishbot.app/items/scrollofgemmagic.png) | Scrollofgemmagic | | | *Consumed upon use, must have 20x eel to use. Will instantly convert 20x eel to 20x random uncut gems.* | | | |
| ![image](https://fishbot.app/items/scrollofmanipulation.png) | Scrollofmanipulation | | | *Consumed upon use, will temporarily increase the price of ALL fish. Only one can be used by anyone each reset, can only be used after payday 15.* | | | |
| ![image](https://fishbot.app/items/scrollofthenight.png) | Scrollofthenight | | | *Consumed upon use, but can only be used on payday 50 or later. Grants +20% double thieve, +20% chance to reset lockpick cooldown... until next reset!* | | | |
| ![image](https://fishbot.app/items/thieverseye.png) | Thieverseye | | | *If worn, +2% thieve xp and whenever finding a vial, theres a small chance to find a bonus thievingpotion, extendedthievingpotion or superthievingpotion. Vials from vialpack dont count. 1 in 300 chance to break per activation* | Yes (Eyes) | | |
| ![image](https://fishbot.app/items/topazsinker.png) | Topazsinker | | | *10% chance to activate when doing an xxl, you will get paid out a bonus 40% of your fishing trips market value,in cash, at the end of your trip.* | | | |
| ![image](https://fishbot.app/items/whitewizardhat.png) | Whitewizardhat | | | *If worn, gives a tiny chance of finding a crushedgem, crushedvial or glowblip from fishing, thieving and doing !make commands* | Yes (Head) | | |
